...
EXTRA_COMPILE_ARGS = ["-Wall", "-fno-strict-aliasing", '-DVERSION="%s"' % (VERSION,)]

# Support for AES-NI-intrinsics is not found everywhere
if sys.platform in ("darwin", "linux") and platform.machine() in ("x86_64", "i386"):
